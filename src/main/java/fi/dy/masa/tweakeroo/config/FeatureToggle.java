...
public enum FeatureToggle implements IHotkeyTogglable, IConfigNotifiable<IConfigBoolean>
{
    ...
    TWEAK_DISABLE_SERVER_DATA_SYNC  ("tweakDisableServerDataSync",          false, "",    "Disables Server Data Syncer for entities, making inventoryPreview cannot render proper data such as Shulker Boxes\nServer Data Syncer will try to detect if you have enough permission."),
